<x-layout>
    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center px-4 space-x-1 md:space-x-2 rtl:space-x-reverse lg:px-12">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="/report_book"
                        class="text-sm font-medium text-gray-700 ms-1 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">List</a>
                </div>
            </li>
        </ol>
    </nav>
    ...
    {{-- Title --}}
    <h3 class="px-4 text-3xl font-bold dark:text-white lg:px-12">Invoice</h3>


    {{-- Table --}}
    <section class="p-3 bg-white dark:bg-gray-900 sm:p-5">

        <div class="max-w-screen-xl px-5 mx-auto lg:px-12">
            <!-- Start coding here -->
            <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                <div
                    ...
                    <div
                        ...
                        <a href="#"
                            class="flex items-center justify-center px-4 py-2 text-sm font-medium text-white rounded-lg bg-amber-500 hover:bg-amber-400 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                stroke="currentColor" class="size-6 h-3.5 w-3.5 mr-2">
                            ...
                            @foreach ($invoiceData as $data)
                                <tr class="border-b dark:border-gray-700">
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $data['nama'] }}</td>
                                    <td class="px-4 py-3">{{ $data['check_in'] }}</td>
                                    <td class="px-4 py-3">{{ $data['check_out'] }}</td>
                                    <td class="px-4 py-3">{{ $data['booking_date'] }}</td>
                                    <td class="px-4 py-3">{{ $data['total_price'] }}</td>
                                    <td class="flex items-center justify-end px-4 py-3">
                                        <div class="relative">
                                            <button id="invoice-dropdown-button-{{ $loop->index }}"
                                                data-dropdown-toggle="invoice-dropdown-{{ $loop->index }}"
                                            ...
                                            <div id="invoice-dropdown-{{ $loop->index }}"
                                                class="absolute right-0 z-10 hidden mt-2 origin-top-right bg-white divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                    aria-labelledby="invoice-dropdown-button-{{ $loop->index }}">
                                                    <li>
                                                        <a href="{{ route('invoice.download', ['guestId' => $data['guest_id']]) }}"
                                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Download</a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('invoice.show', ['guestId' => $data['guest_id']]) }}"
